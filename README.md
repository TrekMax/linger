...
## 方案简介
linger 基于 PyTorch 对聆思 IOT 系列芯片进行深度定制，在神经网络训练的前向过程中将激活和权重量化到 8bit，通过参数调整得到量化无损的 8bit 模型
...
- [onnx 导出教程](doc/tutorial/export_onnx.md)：将量化无损的 PyTorch 模型导出为 ONNX 格式的模型
